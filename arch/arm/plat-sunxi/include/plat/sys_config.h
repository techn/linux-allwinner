...
extern unsigned gpio_request(struct user_gpio_set *gpio_list, unsigned group_count_max);
...
extern int gpio_get_all_pin_status(unsigned p_handler, struct user_gpio_set *gpio_status, unsigned gpio_count_max, unsigned if_get_from_hardware);
extern int gpio_get_one_pin_status(unsigned p_handler, struct user_gpio_set *gpio_status, const char *gpio_name, unsigned if_get_from_hardware);
extern int gpio_set_one_pin_status(unsigned p_handler, struct user_gpio_set *gpio_status, const char *gpio_name, unsigned if_set_to_current_input_status);
